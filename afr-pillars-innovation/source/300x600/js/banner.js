...
function init() {
    ...
    TweenMax.set('.feature', {x:0, y:300, display:'block'})
...
function start() {
    ...
    function featureAnimation() {
        ...
        tlFeature.to('.feature', 0.65, {ease:Power1.easeOut, y:50, rotation:0})
                 ...
                 .to('#droid-1', 0.85, {ease:Power3.easeInOut, scale:0.75, alpha:1, x:14, y:49}, "-=0.85")
                 .to('#droid-2', 0.85, {ease:Power3.easeInOut, scale:0.65, alpha:0.9, x:-25, y:69}, "-=0.85")
                 .to('#droid-3', 0.85, {ease:Power3.easeInOut, scale:0.6, alpha:0.8, x:-58, y:79}, "-=0.85")
                 .to('#droid-4', 0.85, {ease:Power3.easeInOut, scale:0.55, alpha:0.7, x:-90, y:95}, "-=0.85")
