...
function init() {
    ...
    TweenMax.set('#overlay', {width:'728px', height:'100%', position:'absolute', left:'0px', top:'0px'});
    TweenMax.set('.feature', {x:0, y:128});
    TweenMax.set('#water', {x:-250, y:238})
...
function start() {
    ...
    function featureAnimation() {
        tlFeature
                 ...
                 .to('#water', 1.5, {ease:Power1.easeInOut, y:-5}, "-=1.5")
                 .to('#iceberg2', 1.5, {ease:Power1.easeInOut, scale:0.4, x:33}, "-=1.5")
                 .to('#iceberg2 .dollar', 1.5, {ease:Power1.easeInOut, alpha:0.4}, "-=1.5")

                 .to('#main-iceberg', 1.5, {ease:Power1.easeInOut, scale:0.9, y:33, x:30}, "-=1.5")
                 ...
                 .to('#iceberg3', 1.5, {ease:Power1.easeInOut, scale:0.45, x:174}, "-=1.5")
                 .to('#iceberg3 .dollar', 1.5, {ease:Power1.easeInOut, alpha:0.3}, "-=1.5")




                 .to('.feature', 1, {ease:Power1.easeInOut, y:-130, delay:2})
