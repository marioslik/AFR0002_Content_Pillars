...
function start() {
    ...
    function animateWaves(){
        tlWater.to('#water', 1, { x: -30, repeat: 10, repeatDelay:0, yoyo: true, ease: Power1.easeInOut });
    }
    ...
    tl
      ...
      .staggerFrom('.frame-3 p .splitLines', 0.8, {y:-30, alpha:0, ease:Power1.easeInOut}, -0.08, "+=0.0")
