...
function start() {
    ...
    function featureAnimation() {
        tlFeature.to('.feature', 1, {ease:Power1.easeInOut, scale:0.6, x:352, y:-260, delay:4.5})
                 .to('.feature', 0.75, {ease:Power1.easeInOut, x:550, delay:3})
    ...
    tl.set('.panel-03', {x:-300}) // Reset the panels
      ...
      .set('.feature', {scale:0.82, x:407, y:-426})
