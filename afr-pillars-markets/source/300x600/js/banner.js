...
function init() {
    ...
    // Init CSS
    // =========================
    TweenMax.set('.feature', {x:-20, y:20, scale:1.2, display:'block'})
    ...
    TweenMax.set('#bull-horns', {drawSVG:"0%", immediateRender:false});
...
function start() {
    ...
    //   .pause('+=4')
      ...
      .staggerTo('.frame-3 p .splitLines', 0.8, {y:40, alpha:0, ease:Power1.easeInOut, delay:1.5}, -0.08)
      .add('frame04', "-=0.8")
